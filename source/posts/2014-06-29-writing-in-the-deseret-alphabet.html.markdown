...
Since I'm using [Bourbon](https://www.bourbon.io), I can use the magnificent [font-face mixin](https://www.bourbon.io/docs/latest) (I'm also using [Bitters](https://bitters.bourbon.io), so I placed these 3 lines at the bottom of the _typography.scss partial):
